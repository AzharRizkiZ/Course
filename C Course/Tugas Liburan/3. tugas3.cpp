...
int main(){
	...
	printf("Tempat Lahir: ");
	scanf("%s", l_struct_dataChild.TempatLahir);
	...
	printf("Jurusan: ");
	scanf("%s", l_struct_dataChild.Jurusan);
	printf("Golongan Darah: ");
	scanf("%s", l_struct_dataChild.GolDar);
	printf("Agama: ");
	scanf("%s", l_struct_dataChild.Agama);
	printf("Umur: ");
	scanf("%d", l_struct_dataChild.umur);
